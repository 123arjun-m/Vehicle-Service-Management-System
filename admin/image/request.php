...
<div class="col-sm-4 mb-5">
  ...
  <?php 
 $sql = "SELECT request_id, request_service, vehicle_name_model, request_date FROM submitrequest_tb";
 ...
 if($result->num_rows > 0){
  while($row = $result->fetch_assoc()){
   ...
   echo '<h5 class="card-title">Request Service : ' . $row['request_service'] . '</h5>';
   echo '<p class="card-text">' . $row['vehicle_name_model'] . '</p>';
  ...
  <p>Successfully assigned all Requests.</p>
  <hr>
