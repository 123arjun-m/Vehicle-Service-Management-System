...
<body  style="background-image: url(image/admin.jpg); background-repeat: no-repeat; background-size: cover; background-position: center; height: 650px;">

  <div class="mb-3 text-center mt-5"  style="font-size: 30px;">
    <i></i>
    <span><b>Vehicle Service Managment System</b></span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i></i> <span><b>Admin Login</b>
    </span>
  </p>
